      ...
      body: FutureBuilder<_ReconData>(
        ...
        builder: (context, snapshot) {
          ...
          final invoicesFiltered = data.invoices.where((inv) {
            ...
            final nr = _text(inv['factuur_nummer'] ?? inv['factuur_nummer_leverancier']);
            final klant = _text(inv['debiteur_naam'] ?? (inv['bedrijven'] as Map?)?['bedrijfsnaam']);
