    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final maxY = upcoming
              .map((r) => _asDouble(r['verwachte_inkomsten']).abs().toDouble())
              .followedBy(upcoming.map((r) => _asDouble(r['verwachte_uitgaven']).abs().toDouble()))
          ...
          return ListView(
            ...
            children: [
                        ...
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (value, meta) {
                              ...
                              if (idx < 0 || idx >= upcoming.length) return const SizedBox.shrink();
                      ...
                      barTouchData: BarTouchData(
                        ...
                        touchTooltipData: BarTouchTooltipData(
                          ...
                          getTooltipItem: (group, groupIndex, rod, rodIndex) {
                            final label = rodIndex == 0 ? 'Inkomsten' : 'Uitgaven';
              ...
              Row(
                children: [
                  _LegendDot(color: const Color(0xFF19C37D), label: 'Verwachte inkomsten'),
                  const SizedBox(width: 14),
                  _LegendDot(color: const Color(0xFFFF6B6B), label: 'Verwachte uitgaven'),
                ],
              ),
            ],
          );
