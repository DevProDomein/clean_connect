        ...
        return SelectionArea(
          child: Dialog(
            ...
            child: ConstrainedBox(
              ...
              child: PdfPreview(
                build: (format) =>
                    PdfInvoiceService.generateInvoicePdf(invoiceId),
                allowPrinting: true,
                allowSharing: true,
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    columnSpacing: 14,
                    headingRowColor:
                        const WidgetStatePropertyAll(Color(0xFFE9ECEF)),
                    columns: const [
                    ...
                    rows: List.generate(items.length, (i) {
                      ...
                      final zebra =
                          i.isEven ? Colors.white : const Color(0xFFF7F7F7);
                      return DataRow(
                        ...
                        onSelectChanged: (_) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) =>
                                  FactuurEditorScreen(invoiceId: id),
                            ),
                          );
                        },
                        cells: [
